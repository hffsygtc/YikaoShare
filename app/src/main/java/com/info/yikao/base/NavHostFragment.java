...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        Log.e("NavHostFragment","findNavController");
    ...
    public void onAttach(@NonNull Context context) {
        ...
        Log.e("NavHostFragment","onAttach");
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("NavHostFragment","onCreate3");
    ...
    protected void onCreateNavController(@NonNull NavController navController) {
        ...
        Log.e("NavHostFragment","onCreateNavController");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        Log.e("NavHostFragment","onCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.e("NavHostFragment","onViewCreated");
        super.onViewCreated(view, savedInstanceState);
        if (!(view instanceof ViewGroup)) {
            throw new IllegalStateException("created host view " + view + " is not a ViewGroup");
        }
        Log.e("NavHostFragment","setViewNavController1111");
        Navigation.setViewNavController(view, mNavController);
        // When added programmatically, we need to set the NavController on the parent - i.e.,
        // the View that has the ID matching this NavHostFragment.

        Log.e("NavHostFragment","setViewNavController22222" + view);
        if (view.getParent() != null) {

            Log.e("NavHostFragment","setViewNavController555");
            View rootView = (View) view.getParent();
            if (rootView.getId() == getId()) {

                Log.e("NavHostFragment","setViewNavController3333");
                Navigation.setViewNavController(rootView, mNavController);

                Log.e("NavHostFragment","setViewNavController4444");
            }
        }
    }
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs,
        ...
        Log.e("NavHostFragment","onInflate");
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        Log.e("NavHostFragment","onSaveInstanceState");
