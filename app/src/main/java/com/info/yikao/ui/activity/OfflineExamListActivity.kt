 ...
 * 考场列表
 */
class OfflineExamListActivity : BaseActivity<OfflineClassListViewModel, ActivitySingleListF5Binding>() {
...
//                var posData = adapter.data[position] as StreetShowBean
                val intent = Intent(this@OfflineExamListActivity, OfflineMangerQrActivity::class.java)
