...
import com.info.yikao.databinding.FragmentCaptureBinding
import kotlinx.coroutines.*
import java.util.*
import com.info.yikao.R
import com.info.yikao.ext.getAspectRatio
import com.info.yikao.ext.getAspectRatioString
...
class CaptureFragment : Fragment() {
    ...
    private val captureListener = Consumer<VideoRecordEvent> { event ->
        "captureListener 录像回调 >>>>  $event".logw()
...
//                    captureViewBinding.captureButton.setImageResource(R.drawable.ic_pause)
    ...
    private fun enableUI(enable: Boolean) {
        arrayOf(captureViewBinding.cameraButton,
                captureViewBinding.captureButton).forEach {
                    it.isEnabled = enable
        }
