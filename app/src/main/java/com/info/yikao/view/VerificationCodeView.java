...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtTextEmptyBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_empty_bg, R.drawable.et_login_code);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_cursor, R.drawable.et_corsor);
    ...
    private void initEditText(EditText editText, int i) {
        ...
        editText.setBackgroundResource(mEtTextEmptyBg);
